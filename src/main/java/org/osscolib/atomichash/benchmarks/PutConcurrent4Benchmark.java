...
public abstract class PutConcurrent4Benchmark {
    ...
    protected PutConcurrent4Benchmark(final Supplier<Map<String,String>> mapSupplier) {
        super();
        this.benchmarkMaps = new BenchmarkMaps(
                100000, BenchmarkConstants.CONCURRENT4_TEST_NUM_THREADS, 0, benchmarkValues, mapSupplier);
    }
    ...
    private static abstract class AtomicPutBenchmark extends PutConcurrent4Benchmark {
    ...
    private static abstract class SynchronizedPutBenchmark extends PutConcurrent4Benchmark {
